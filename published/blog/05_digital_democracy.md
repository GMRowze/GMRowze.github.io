---
title: "Digital Democracy (part I): the missing political party"
# description: "(Yo-ho, a pirate's life for me)"
date: 2026-05-27
tags:
  - Politics
  - Technology
...
<!-- This is a repost from my old blog. The old post is from 2025-11-20 -->

![](https://images.squarespace-cdn.com/content/v1/5485a75de4b034a63cc7a6f2/fb270b55-b447-4d5b-8d82-4bc053e66f3a/EU+Parlament_LT_chamber_01.jpg)
...
When Gutenberg built his press in 1440, he triggered a _priting revolution_. Humanity suddenly had a tool capable of multiplying knowledge beyond anything previously imaginable. Information could be reproduced, distributed, and shared at a scale that fundamentally reshaped society.

But not everything the press produced was good. If you know anything about history (rather than repeating the usual myths), you'd know that the [medieval period had no large-scale witch hunts, and burning at the stake was rare]((/the-dark-ages-wall-of-shame/#:~:text=Whitch%20Hunts,-History)). Mainstream Christian doctrine rejected the existence of witches for most of the Middle Ages.

So what changed?

In 1486, a very unhappy man named Heinrich Kramer (a German, of course) wrote one of the first true bestsellers: the Malleus Maleficarum, often translated to _The Hammer of Witches_. This book massively popularized the idea of witches and helped manufacture moral panics across Europe and later Americas. Once printed and distributed widely, it gave justification to wave after wave of witch hunts. In short: one man's stupid obsession went "viral" centuries before the word existed.
...
It is the only system where ideas like [Blackstone's ratio](https://en.wikipedia.org/wiki/Blackstone's_ratio) can exist, because it is the only system where every citizen is equal before the law, and where each person is sovereign over themselves.
...
Representative democracies face familiar problems: low participation between elections, information asymmetries between citizens and institutions, slow feedback loops, and policymaking shaped by organized minorities rather than the general public. Digital tools cannot *solve* these issues ([Ranum's Law](https://en.wikipedia.org/wiki/Marcus_J._Ranum#Ranum's_law)), but they can reduce some of the structural imbalances.
...
Well, if any of the political ideas here piqued your interest (or, if you found yourself nodding along or thinking "yeah, that makes sense") then let it be known that you just read my long rant-take on the main talking points of the [Pirate Party](https://en.wikipedia.org/wiki/Pirate_Party).
